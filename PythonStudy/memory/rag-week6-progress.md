...
**下次起点**：Day 40（FastAPI 检索服务）
- 计划文档：`docs/plans/rag/week6/day40-retrieval-service.md`
- 前置依赖：Day38/39 的 bge-m3 检索链路 + 11 文档知识库已就绪

**Week6 剩余**：Day 40 FastAPI 服务 → Day 41 复盘
